...
/* harmony import */ var _icons_sheet_svg__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @/icons/sheet.svg */ "./icons/sheet.svg");
/* harmony import */ var _icons_sheet_svg__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_icons_sheet_svg__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _pages_error__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @/pages/_error */ "./pages/_error.js");
/* harmony import */ var _utilities_confirm__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @/utilities/confirm */ "./utilities/confirm.js");
/* harmony import */ var _utilities_pluck__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @/utilities/pluck */ "./utilities/pluck.js");
/* harmony import */ var _utilities_URI__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @/utilities/URI */ "./utilities/URI.js");
/* harmony import */ var _user_scss__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./user.scss */ "./pages/user.scss");
/* harmony import */ var _user_scss__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_user_scss__WEBPACK_IMPORTED_MODULE_25__);
...
function (_Component) {
  ...
  function UserPage() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this)), "state", {
      saved: Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(_this.props.user, UPDATABLE_FIELDS),
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return fetch("/api/user/".concat(_this.state.user.username || ''), {
                body: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(_this.state.user, UPDATABLE_FIELDS)),
                headers: {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return Object(_utilities_confirm__WEBPACK_IMPORTED_MODULE_22__["default"])("Are you sure you want to ".concat(action, " this user Admin privileges?"));
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this)), "render", function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", {
        ...
        caption: "Favorites",
        icon: react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_icons_favorite_on_svg__WEBPACK_IMPORTED_MODULE_19___default.a, {
        ...
        caption: "Campaigns",
        icon: react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_icons_sheet_svg__WEBPACK_IMPORTED_MODULE_20___default.a, null),
        pages: user.campaigns.map(function (campaign) {
          return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, campaign, {
            campaign: campaign
          });
        }),
        type: "campaign"
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(UserPage, [{
    key: "isDirty",
    get: function get() {
      var fromState = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(this.state.user, UPDATABLE_FIELDS));

      var fromSaved = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(this.state.saved, UPDATABLE_FIELDS));
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (props.user.username !== state.user.username) {
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_3__["default"])({}, state, {
          saved: Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(props.user, UPDATABLE_FIELDS),
          user: props.user
        });
      }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            headers = Object(_utilities_pluck__WEBPACK_IMPORTED_MODULE_23__["default"])(req && req.headers, 'cookie');
            _context3.next = 4;
            return fetch(Object(_utilities_URI__WEBPACK_IMPORTED_MODULE_24__["default"])(req, "/api/user/".concat(query.slug)), {
              headers: headers
            });
...
//# sourceMappingURL=user.js.cb82c0cc7cdc2056f40c.hot-update.js.map