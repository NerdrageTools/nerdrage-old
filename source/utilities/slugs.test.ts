...
describe('slugify()', () => {
	...
	test('eliminates special characters, double-dashes, leading/trailling dashes', () => {
...
describe('slugifyUrl()', () => {
	...
	test('handles / terminated urls properly', () => {
