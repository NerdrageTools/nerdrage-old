...
describe('server/controllers/ArticleController', () => {
	describe('permissions', () => {
		...
		test('returns 401 to non-editors if required', async done => {
		...
		test('returns 401 to non-viewers if article is secret', async done => {
	...
	describe('getArticle', () => {
		...
		test('returns 200 and defaults for articles not found', async done => {
	...
	describe('upsertArticle', () => {
		...
		test('always writes to current campaign', async done => {
	...
	describe('deleteArticle', () => {
		...
		test('returns 204 even if article is not found', async done => {
